...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Services Intro Page', 'options_check'),
		'desc' => __('Select a page to use as the intro content for the services section', 'options_check'),
		'id' => 'services_intro_page',
		'type' => 'select',
		'options' => $options_pages);
	$options[] = array(
		'name' => __('Case Studies Intro Page', 'options_check'),
		'desc' => __('Select a page to use as the intro content for the case studies section', 'options_check'),
		'id' => 'case_studies_intro_page',
		'type' => 'select',
		'options' => $options_pages);
	$options[] = array(
		'name' => __('Artists Intro a Page', 'options_check'),
		'desc' => __('Select a page to use as the intro content for the artists section', 'options_check'),
		'id' => 'artists_intro_page',
		'type' => 'select',
		'options' => $options_pages);
	$options[] = array(
		'name' => __('Clients Intro a Page', 'options_check'),
		'desc' => __('Select a page to use as the intro content for the clients section', 'options_check'),
		'id' => 'clients_intro_page',
		'type' => 'select',
		'options' => $options_pages);
	...
	/*
	//Here's the code to make a WYSYWG editor
